...
data77_1 = data77 %>% 
  filter(treatment %in% c("Kp77","Kp77+KP15","Kp77+KP36", "Kp77+KP36gp50", "Kp77+cocktail(KP36gp50+KP15)", "Kp77+cocktail(KP36+KP15)")) %>%
  mutate(type= "Kp77 + KP36 + KP15")

data77_2 = data77 %>% 
  filter(treatment %in% c("Kp77","Kp77+KP15","Kp77+KP34", "Kp77+KP34gp57", "Kp77+cocktail(KP34gp57+KP15)", "Kp77+cocktail(KP34+KP15)")) %>%
  mutate(type= "Kp77 + KP34 + KP15")

data77_3 = data77 %>% 
  filter(treatment %in% c("Kp77","Kp77+KP27", "Kp77+KP36","Kp77+KP36gp50", "Kp77+cocktail(KP36gp50+KP27)", "Kp77+cocktail(KP36+KP27)")) %>%
  mutate(type= "Kp77 + KP36 + KP27")

data77_4 = data77 %>% 
  filter(treatment %in% c("Kp77","Kp77+KP27", "Kp77+KP34","Kp77+KP34gp57", "Kp77+cocktail(KP34gp57+KP27)", "Kp77+cocktail(KP34+KP27)")) %>%
  mutate(type= "Kp77 + KP34 + KP27")

data77 = rbind(data77_1, data77_2, data77_3, data77_4)

data486_1 = data486 %>% 
  filter(treatment %in% c("Kp486","Kp486+KP15","Kp486+KP36",  "Kp486+KP36gp50", "Kp486+cocktail(KP36gp50+KP15)", "Kp486+cocktail(KP36+KP15)")) %>%
  mutate(type= "Kp486 + KP36 + KP15")

data486_2 = data486 %>% 
  filter(treatment %in% c("Kp486","Kp486+KP15", "Kp486+KP34", "Kp486+KP34gp57", "Kp486+cocktail(KP34gp57+KP15)", "Kp486+cocktail(KP34+KP15)")) %>%
  mutate(type= "Kp486 + KP34 + KP15")

data486_3 = data486 %>% 
  filter(treatment %in% c("Kp486","Kp486+KP27", "Kp486+KP36", "Kp486+KP36gp50", "Kp486+cocktail(KP36gp50+KP27)", "Kp486+cocktail(KP36+KP27)")) %>%
  mutate(type= "Kp486 + KP36 + KP27")

data486_4 = data486 %>% 
  filter(treatment %in% c("Kp486","Kp486+KP27", "Kp486+KP34", "Kp486+KP34gp57", "Kp486+cocktail(KP34gp57+KP27)", "Kp486+cocktail(KP34+KP27)")) %>%
...
data$treat[data$treatment %in% c("Kp77+cocktail(KP34gp57+KP27)" , 
                                 "Kp77+cocktail(KP34gp57+KP15)",
                                 "Kp77+cocktail(KP36gp50+KP27)", 
                                 "Kp77+cocktail(KP36gp50+KP15)",
                                 "Kp486+cocktail(KP34gp57+KP27)" , 
                                 "Kp486+cocktail(KP34gp57+KP15)",
                                 "Kp486+cocktail(KP36gp50+KP27)", 
                                 "Kp486+cocktail(KP36gp50+KP15)"
                                     )] = "All bacteria: with P_N plus depo"

data$treat[data$treatment %in% c("Kp77+cocktail(KP34+KP27)" , 
                                 "Kp77+cocktail(KP34+KP15)",
                                 "Kp77+cocktail(KP36+KP27)", 
                                 "Kp77+cocktail(KP36+KP15)",
                                 "Kp486+cocktail(KP34+KP27)" , 
                                 "Kp486+cocktail(KP34+KP15)",
                                 "Kp486+cocktail(KP36+KP27)", 
                                 "Kp486+cocktail(KP36+KP15)"
...
## Sequential vs Parallel cocktail

### Assuming all the receptors are dropped at once 
...
### 17) Cocktails at different proportions of P_N and P_P
#### Parameters 
- beta_non_depo = 5
